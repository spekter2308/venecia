...
//this class created because i not have enough time to create normal classes (deadline) customer cut terms
class MainPhotoStatic{
...
//        DB::table('main_static_page_images')->insert(
