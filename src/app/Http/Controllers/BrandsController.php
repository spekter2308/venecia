...
class BrandsController extends Controller {
    ...
    use BrandAllTrait, CartTrait,CategoryTrait;
    ...
    public function getProductsForBrand($id) {
        ...
        // ( Count how many items in Cart for signed in user )
        $cart_count = $this->countProductsInCart();
        //Select all categoty from DB in nav-bar
    ...
    public function store(BrandsRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            flash()->success('Успіх', 'Бренд створений!');
        }
    ...
    public function update($id, BrandsRequest $request) {
        ...
        if (Auth::user()->id == 2) {
            ...
            flash()->success('Успіх', 'Бренд обновлено!');
        }
    ...
    public function delete($id) {
        ...
        if ($products > 0) {
            ...
            flash()->customErrorOverlay('Помилка', 'Неможливо видалити цей бренд, поки всі продукти під цім брендом видалено не буде');
