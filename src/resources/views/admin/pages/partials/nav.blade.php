        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                @else
                    ...
                    <li><a href="{{ route('callback') }}"><i class="material-icons" style="width: 24px;color: black; ">mail-box</i><span class="badge green">{{ $countCallback }}</span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                    <li class="dropdown">
                    ...
                    <li><a href="{{ route("import") }}" class="btn btn-primary">Загрузити товари</a></li>
                @endif
            </ul>
        </div>
