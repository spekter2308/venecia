        ...
        <div class="container-fluid" id="Admin_Dashboard_Container">
            <div class="row" id="Admin_Dashboard_Row">
                ...
                <div class="col-lg-12" id="Admin_Dashboard-col-md-12">
                    <h4 id="Admin-Heading">Панель Адміністратора</h4><br>


                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading success-color-dark white-text"><i class="fa fa-money" aria-hidden="true"></i> &nbsp;Код знижки</div>
                            <div class="panel-body">
                                <div style="overflow-x:hidden; height: 285px; width: 100%;">
                                    @include('admin.pages.partials.discount')
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading default-color white-text"><i class="fa fa-users" aria-hidden="true"></i> &nbsp;Користувачі</div>
                            <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading default-color white-text"><i class="fa fa-archive" aria-hidden="true"></i> Замовлення в один клік</div>
                            <div class="panel-body">
                                <div style="overflow: auto; max-height: 500px;">
                                    @include('admin.pages.partials.one_click_orders')
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                        {{--<div class="panel panel-default">--}}
                            {{--<div class="panel-heading info-color-dark white-text"><i class="fa fa-shopping-cart" aria-hidden="true"></i> &nbsp;Замовлення</div>--}}
                            {{--<div class="panel-body">--}}
                                {{--<div style="overflow: auto; height: 275px;">--}}
                ...
                <div class="col-lg-12" id="Admin_Dashboard-col-md-12">
                    ...
                    <div class="col-lg-12" id="Admin_Dashboard-col-md-12">
                        ...
                        {{--<div class="col-sm-12 col-md-12">--}}
                            {{--<div class="panel panel-default">--}}
                                {{--<div class="panel-heading warning-color white-text"><i class="fa fa-cart-plus" aria-hidden="true"></i> &nbsp;Активні сесії покупок</div>--}}
                                {{--<div class="panel-body">--}}
                                    {{--<div style="overflow: auto; height: 275px;">--}}
                    ...
                    {{--<div class="col-sm-12 col-md-6">--}}
                        {{--<div class="panel panel-default">--}}
                        {{--<div class="panel-heading primary-color white-text"><i class="fa fa-google-plus" aria-hidden="true"></i> &nbsp;Відвідувачі</div>--}}
                        {{--<div class="panel-body">--}}
                            {{--<div style="overflow: auto; height: 275px;">--}}
