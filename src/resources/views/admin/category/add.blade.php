            ...
            <form role="form" method="POST" action="{{ route('admin.category.post') }}">
                ...
                <li class="collection-item">
                    ...
                    <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" name="category" value="{{ old('category') }}" placeholder="Додати категорію">
                ...
                <li class="collection-item">
                    <label for="category_ru">Російська назва</label>
                    <div class="form-group{{ $errors->has('category_ru') ? ' has-error' : '' }}">
                        <input type="text" class="form-control" name="category_ru" value="{{ old('category_ru') }}" placeholder="Додати категорію">
                ...
                <li class="collection-item">
                    ...
                    <div class="form-group{{ $errors->has('is_marked') ? ' has-error' : '' }}">
                        <div class="checkbox">
                            <label style="color: #dd5656;"><input type="checkbox" value="1" name="is_marked" {{(old('is_marked')) ? "checked" : "" }}>Позначити категорію червоним</label>
                        </div>
                    </div>
                </li>
                ...
                <li class="collection-item blue">
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-link grey lighten-5">створити категорію</button>
                    </div>
                </li>
            </form>
        </ul>
