                ...
                <form role="form" method="POST" action="{{ route('admin.category.update', $category->id) }}">
                    ...
                    <li class="collection-item">
                        ...
                        <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                            <input type="text" class="form-control" name="category"  value="{{  Request::old('category') ? : $category->category }}" placeholder="редагувати категорію">
                    ...
                    <li class="collection-item">
                        ...
                        <div class="form-group{{ $errors->has('category_ru') ? ' has-error' : '' }}">
                            <input type="text" class="form-control" name="category_ru"  value="{{  Request::old('category_ru') ? : $category->category_ru }}" placeholder="редагувати категорію">
                    ...
                    <li class="collection-item">
                        <label for="is_marked">Позначити категорію червоним</label>
                        <div class="form-group{{ $errors->has('is_marked') ? ' has-error' : '' }}">
                            <div class="checkbox">
                                <label style="color: #dd5656;"><input type="checkbox" value="1" name="is_marked" {{($category->is_marked) ? "checked" : "" }}>Позначити категорію червоним</label>
                            </div>
                        </div>
                    </li>
                    <!-- Tab panes -->
                    ...
                    <li class="collection-item blue">
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-link grey lighten-5">редагувати категорію</button>
                        </div>
                    </li>
                </form>
            </ul>
