...
@section('content')
    ...
    <div class="container-fluid" id="admin-brand-container">
        ...
        <a href="{{ url('admin/brands/create') }}" class="btn btn-primary">Додати новий бренд</a>
            <br><br>
        ...
        <div class="col-md-9" id="admin-brand-container">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-center blue white-text"></th>
                    <th class="text-center blue white-text"></th>
                    <th class="text-center blue white-text">Бренди</th>
                    <th class="text-center blue white-text" id="td-display-mobile"># Продуктів</th>
                </tr>
                </thead>
                <tbody>
