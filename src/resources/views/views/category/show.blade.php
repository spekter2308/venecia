    ...
    <section class="contentbox container-fluid">
        <div class="row">
            ...
            <div class="products">
                                ...
                                <ul class="actions">
                                    <li>
                                        ...
                                        <a href="javascript:;" class="addToCart" data-id="{{$product->id}}">
                                            <img src="/src/public/img/svg/add_cart_white.svg" alt="Add cart"/>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('show.product',  $product->id  ) }}"><img
                                                    src="/src/public/img/svg/eye_white.svg" alt="Eye"/></a>
                                    </li>
                                </ul>
                                </form>
                ...
                <form action="{{ route('category.showAll', $categoryId) }}" class="row paginator" style="margin-top: 30px;" method="get" >
